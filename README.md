...
Параметры из блока "Настройки подключения к онлайн кассе" необходимо указать только если Вы подключены к [онлайн кассе](https://arsenalpay.ru/documentation.html#54-fz-integraciya-s-onlajn-kassoj):
1. Выберите налоговую ставку по умолчанию (будет применина, если для товара или доставки не указан другой НДС)
2. Следом за налоговой ставкой по умолчанию, вы увидите список ставок НДС в вашем магазине. Сопоставьте их со ставками НДС, которые будут указаны в чеке. (Инструкцию по настройке НДС в магазине bitrix можно найти [тут](https://dev.1c-bitrix.ru/learning/course/?COURSE_ID=42&LESSON_ID=3458)) 
